Feature: Trade Validations Feature
  ...
  @Defect
  Scenario: Defect: Verify the Validate endpoint for Valid Data. Exception is coming for Product Type Trade after hitting the post request for all Valid Data
